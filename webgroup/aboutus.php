...
<body>
    ...
    <div class="intro">
        ...
        <img src="image/two.png" alt="Graduation Illustration">
    </div>
    ...
    <!-- Fetaures Section 1 -->
    <div class="features">
        <img src="image/pile.jpg" alt="Join Communities">
    ...
    <!-- Features Section 2 -->
    <div class="features">
        <img src="image/study.jpg" alt="Share Notes">
    ...
    <!-- Features Section 3 -->
    <div class="features">
        <img src="image/clock.jpg" alt="Pomodoro Timer">
...
<h2>What You Can Achieve</h2>
    <div class="cards">
            <div class="card">
                ...
                <img src="image/target.jpg" alt="img1">
            </div>
            <div class="card">
                ...
                <img src="image/notepad.jpg" alt="img2" style="padding: 20px;">
            </div>
            <div class="card">
                ...
                <img src="image/stop.jpg" alt="img3" style="padding: 15px;">
            </div>
    </div>
</div>
...
<div class="intro" style="background-color: white;">
    <div class="content">
        ...
        <img src="image/team.jpg" alt="img4">
